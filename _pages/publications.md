...
Wooje Chang, Seungwoo Je, Michel Pahud, Mike Sinclair, and Andrea Bianchi, **Rendering Perceived Terrain Stiffness in VR Via Preload Variation Against Body-Weight**. In IEEE Transactions on Haptics. [https://doi.org/10.1109/TOH.2023.3275136](https://doi.org/10.1109/TOH.2023.3275136). (**Best student presentation award** 🏆)
...
Hye-Young Jo, Wooje Chang, Hoonjin Jung, Andrea Bianchi. 2022. **Design of Virtual Reality Application for Interaction Prototyping Remote Education**. In _HCI Korea 2022_ [[paper]]({{ site.url }}/files/2022/files/2022/Jo_PcompMetaverse_KHCI22.pdf) (2022.02.09 - 02.11, **Best paper award** 🏆)
